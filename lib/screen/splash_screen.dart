...
import 'package:project_flutter_lnt/screen/login_screen.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    context,
    MaterialPageRoute(builder: (context) => LoginScreen()), // Replace 'NextScreen' with the correct method name or define a method named 'NextScreen'
    );
    });
  }
        ...
        child: Center(
          child: Column(
            ...
            const SizedBox(height: 15),
              Text(
                'Read Book Upskill your Brain', // Teks yang ingin ditampilkan
                style: GoogleFonts.ubuntu(
                  fontSize: 20,
